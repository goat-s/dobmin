/****************************************************************************
** Meta object code from reading C++ file 'thememanager_minimal.h'
**
...
#error "The header file 'thememanager_minimal.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 12), // "styleApplied"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "ThemeManager\0styleApplied\0"
};
...
void ThemeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThemeManager::styleApplied)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThemeManager::styleApplied()
{
